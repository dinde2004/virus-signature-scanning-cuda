...
do
    ...
    # ncu -o ncu/kernel_${i} ./matcher tests/samp_${i}.fastq tests/sig_${i}.fasta > tests/out_${i}.out
    # ncu -o ncu/benchmark_${i} ./bench-h100 tests/samp_${i}.fastq tests/sig_${i}.fasta > tests/out_${i}.ans
done
